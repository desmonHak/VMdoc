...
de métodos reales (el resto cae a interp). Un futuro C2 optimizing
añadirá regalloc, inline, escape analysis y especulación para
acercarse a la paridad con C nativo.
...
Subir el major cuando cambien firmas (breaking change). Subir el minor
cuando se añadan funciones sin romper firmas existentes.
