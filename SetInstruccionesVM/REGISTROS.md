...
Lo especial es que cada registro tiene acceso a partes mas pequeñas de si mismo:
...
// El modo de tamaño se codifica con 2 bits adicionales:
// 0b00 = byte (8 bits)
// 0b01 = word (16 bits)
// 0b10 = dword (32 bits)
// 0b11 = qword (64 bits)
...
valor (PUSH), RSP se decrementa en el tamaño del valor. Cuando se saca (POP), RSP se incrementa.
...
Los cursores son registros especiales del tamaño de un puntero nativo del sistema operativo
