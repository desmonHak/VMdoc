...
tamaño viene determinado por el sufijo del registro destino:
- `b` = 1 byte (`uint8_t`)
- `w` = 2 bytes (`uint16_t`)
- `d` = 4 bytes (`uint32_t`)
...
- `mm` = modo de tamaño: `00`=byte, `01`=word, `10`=dword, `11`=qword
...
tamaño viene determinado por el sufijo del registro fuente.
