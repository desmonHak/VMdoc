...
| Instruccion | opcode | byte2 | destino | Tamaño | Descripcion |
| :--------------: | :----: | :---: | :--------------: | :------: | :------------------------ |
...
1. Calcula `ret_addr = RIP + tamaño_instruccion` (la siguiente instrucción después del callvm).
...
- Bits 5-4: modo de tamaño (solo si reg general)
