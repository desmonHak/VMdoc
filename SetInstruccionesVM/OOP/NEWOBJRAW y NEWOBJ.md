...
2. Si `reg_size != R00` (indice 0): usa ese valor como tamaño total.
...
```c
// Crear objeto con tamaño explicito
mov r1, my_class_ptr // r1 = ClassInfo host ptr
mov r2, 72 // tamaño: 24B (ObjectHeader) + 48B de campos
...
- `reg_sz` (4 bits altos de byte3) = indice del registro con el tamaño; `0` = usar `instance_size`
