...
Regla practica:
- Usa variantes **U** para: contadores, tamaños, punteros, mascaras de bits.
...
## Acceso a memoria con sufijos de tamaño

El tamaño del registro dentro de corchetes `[]` indica cuantos bytes se leen o escriben:

```c
mov r0, 0x123456789ABCDEF // r0 = la direccion base

// Leer distintos tamaños desde esa direccion:
...
| Instruccion | opcode1 | byte2 | Tamaño |
| :---------: | :-----: | :--------------: | :----: |
...
| Instruccion | opcode1 | opcode2 | Tamaño |
| :---------------------------- | :-----: | :-----: | :----: |
