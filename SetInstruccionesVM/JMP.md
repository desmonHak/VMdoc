...
| Instruccion | opcode1 | cond (1 byte) | direccion (64 bits) | Tamaño |
| :----------: | :-----: | :-----------: | :--------------------: | :------: |
...
- `CMPU` + `jmp.je/jne/jhi/jls/jcs/jcc`: comparacion **sin signo** (para valores unsigned como direcciones, tamaños, contadores).
...
| Instruccion | opcode1 | byte2 (registro) | Tamaño |
| :----------: | :-----: | :---------------------------: | :-----: |
...
mov r1, 2 // indice = 2
mulu r1, 8 // offset = indice * 8 bytes (tamaño de puntero)
...
| Instruccion | opcode1 | opcode2 | cond | padding | disp32 | Tamaño |
| :----------------: | :-----: | :-----: | :----: | :-----: | :--------: | :-----: |
...
| Instruccion | Tamaño | Destino | Condicional | Tipico uso |
| :------------- | :------: | :--------------- | :---------: | :--------------------- |
