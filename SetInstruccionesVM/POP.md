...
| Instruccion | opcode | byte2 (reg) | Tamaño | Descripcion |
| :------------: | :----: | :-------------: | :-----: | :--------------------------- |
...
2. `RSP = RSP + tamaño` (la pila se encoge hacia arriba)
...
bits 5-4 = modo de tamaño (0b11=64b, 0b10=32b, 0b01=16b, 0b00=8b)
